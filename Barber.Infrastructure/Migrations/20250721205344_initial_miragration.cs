...
{
    /// <inheritdoc />sss
    public partial class initial_miragration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Barbers_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceHistories_Barbers_BarberId",
                        column: x => x.BarberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Barbers_LocationId",
                table: "Barbers",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceHistories_BarberId",
